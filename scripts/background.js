...
const rules = [
	{
		...
		action: {
			type: "redirect",
			redirect: {
				transform: { queryTransform: { addOrReplaceParams: [{ key: "target", value: "t" }] } }
			}
		},
		condition: {
			urlFilter: "|https://wx.qq.com/|https://web.wechat.com/|https://wx2.qq.com/|https://wx8.qq.com/",
